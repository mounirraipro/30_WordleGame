...
export const metadata: Metadata = {
    ...
    description: 'Read the Wordle Game Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['Wordle Game privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At Wordle Game, we are committed to protecting your privacy and ensuring transparency
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of Wordle Game, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    Wordle Game is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@wordle-game.site</strong>.
                </p>
            </div>
        </>
    );
