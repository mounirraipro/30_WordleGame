...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Wordle Game. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Wordle Game sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Wordle Game' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Wordle Game?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Wordle Game.</p>
                </div>
            </div>
