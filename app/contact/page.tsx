...
const SUPPORT_EMAIL = 'hello@wordle-game.site';

export const metadata: Metadata = {
    title: 'Contact Wordle Game',
    description: 'Get in touch with the Wordle Game team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Wordle Game', 'Wordle Game support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
