...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Wordle Game',
        url: 'https://wordle-game.site/about',
        description: 'Learn about Wordle Game, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Wordle Game',
...
export const metadata: Metadata = {
    title: 'About Us – Wordle Game',
    description: 'Learn about Wordle Game, our mission, and the team behind the game.',
    keywords: ['about Wordle Game', 'game team', 'who made Wordle Game'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Wordle Game</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Wordle Game was born from a simple idea: what if playing Wordle Game could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Wordle Game with a clear vision — to create a free, accessible, and
                    ...
                    Wordle Game has something for you.
                </p>
                ...
                <p>
                    Every level in Wordle Game is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Wordle Game offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Wordle Game better for
                    everyone.
                </p>
            </div>
        </>
