...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Wordle Game puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Wordle Game categories'],
  alternates: {
