...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Wordle Game disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Wordle Game disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Wordle Game (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on wordle-game.site
                ...
                <p>
                    Wordle Game is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Wordle Game displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Wordle Game.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Wordle Game is not responsible for any errors
