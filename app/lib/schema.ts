...
const SITE_URL = 'https://wordle-game.site';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Wordle Game',
        url: SITE_URL,
        description: 'Play Wordle Game free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Wordle Game online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
